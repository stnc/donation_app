...
<div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Sms Taslak Düzenle</span>
        <h3 class="page-title">Sms Taslak  Düzenle</h3>
    </div>
</div>
<!-- End Page Header -->
{!! Form::model($posts, ['method' => 'PATCH','files'=>'true', 'class' => ' add-new-post', "id"=>"formId", 'route' => ['smstaslak.update', $posts->id]]) !!}
